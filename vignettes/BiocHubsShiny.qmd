...
knitr::include_graphics("../man/figures/BiocHubsShiny.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("../man/figures/MusMusculus.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("../man/figures/MusMusculusSelection.png")
```
...
```{r}
#| echo: false
knitr::include_graphics("../man/figures/MusMusculusCode.png")
```
